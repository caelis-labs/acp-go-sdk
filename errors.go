...
// NewServerOverloaded reports bounded connection admission failure.
func NewServerOverloaded(data any) *RequestError {
	return &RequestError{Code: -32001, Message: "Server overloaded", Data: data}
}
