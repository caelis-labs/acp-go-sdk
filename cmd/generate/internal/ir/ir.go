...
const (
	...
	// Agent bindings
	BindAgent
	BindAgentAuthenticator
	BindAgentLogout
	BindAgentLoader
	BindAgentSessionCloser
	BindAgentSessionDeleter
	BindAgentSessionLister
	BindAgentSessionResumer
	BindAgentSessionConfig
	BindAgentSessionMode
	BindAgentExperimental
	// Client bindings
	BindClient
	BindClientFileReader
	BindClientFileWriter
	BindClientElicitation
	BindClientElicitationCompletion
...
func classifyBinding(schema *load.Schema, mi *MethodInfo) MethodBinding {
	...
	case "agent":
		switch mi.Method {
		case "authenticate":
			return BindAgentAuthenticator
		case "logout":
			return BindAgentLogout
		case "session/load":
			return BindAgentLoader
		case "session/close":
			return BindAgentSessionCloser
		case "session/delete":
			return BindAgentSessionDeleter
		case "session/list":
			return BindAgentSessionLister
		case "session/resume":
			return BindAgentSessionResumer
		case "session/set_config_option":
			return BindAgentSessionConfig
		case "session/set_mode":
			return BindAgentSessionMode
		}
	...
	case "client":
		...
		case "fs/read_text_file":
			return BindClientFileReader
		case "fs/write_text_file":
			return BindClientFileWriter
		case "elicitation/create":
			return BindClientElicitation
		case "elicitation/complete":
			return BindClientElicitationCompletion
